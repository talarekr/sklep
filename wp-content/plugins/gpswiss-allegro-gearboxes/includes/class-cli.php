...
class Cli
{
    private const CHECKPOINT_OPTION_KEY = 'gag_listing_images_regen_checkpoint';
    ...
    public function register(): void
    {
        ...
        \WP_CLI::add_command('gag listing-images regenerate', [$this, 'regenerate_listing_images']);
        \WP_CLI::add_command('gag listing-images inspect-front', [$this, 'inspect_front_listing_images']);
    }
