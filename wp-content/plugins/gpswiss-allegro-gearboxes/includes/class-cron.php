...
class Cron
{
    private const ACTION_SCHEDULER_GROUP = 'gag';
    ...
    private const ALREADY_EXISTS_LOG_TRANSIENT_KEY = 'gag_background_sync_exists_log';
    private const ADMIN_REPAIR_TRANSIENT_KEY = 'gag_background_sync_admin_repair';
    ...
    public function hooks(): void
    {
        ...
        $this->logger->info('CRON_HOOK_REGISTERED', [
            ...
            'class' => __CLASS__,
            'build' => defined('GAG_PLUGIN_BUILD') ? GAG_PLUGIN_BUILD : 'unknown',
            'accepted_args' => 1,
    ...
    {
        $schedules['gag_15_minutes'] = [
            'interval' => 15 * MINUTE_IN_SECONDS,
            'display' => __('Co 15 minut (Allegro Import)', 'gpswiss-allegro-gearboxes'),
        ];
    ...
    public function schedule_manual_sync_now(array $context): int
    {
        ...
        $action_id = as_enqueue_async_action(Plugin::CRON_HOOK, [$context], 'gag-manual');
        if (empty($action_id)) {
            $this->logger->error('MANUAL_SYNC_ERROR', [
