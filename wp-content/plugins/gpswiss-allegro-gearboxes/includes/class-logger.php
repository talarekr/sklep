...
class Logger
{
    ...
    private const LOG_THROTTLE_TRANSIENT_PREFIX = 'gag_log_throttle_';
    ...
    public function __construct()
    {
        ...
        $this->file = $dir . 'gpswiss-allegro-gearboxes.log';
    }
    ...
    {
        if (defined('GAG_DEBUG_LOG')) {
            return (bool) GAG_DEBUG_LOG;
        }
    ...
    private function resolve_request_id(): string
    {
        ...
        $request_id = function_exists('wp_generate_uuid4') ? (string) wp_generate_uuid4() : uniqid('gag_', true);
        return $request_id;
    }
