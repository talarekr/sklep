...
class ProductMapper
{
    ...
    // Keep listing-image meta compatible with the main Allegro importer because the storefront card helper reads AWI/GP keys.
    // Offer ownership still stays on Gearboxes-only meta; do not write _allegro_offer_id here.
    ...
    public function find_existing_product_id_for_offer(array $offer): int
    {
        ...
        return $this->find_product_id_by_offer_id($offer_id);
    }
