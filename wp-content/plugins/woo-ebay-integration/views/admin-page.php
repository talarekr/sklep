...
<div class="wrap wei-admin">
    ...
    <details class="wei-box">
        ...
        <details><summary>Readiness scans and category reports</summary>
            ...
            <div class="wei-actions"><form method="post" action="<?php echo esc_url($adminPostUrl); ?>"><?php wp_nonce_field('wei_generate_ebay_de_category_suggestions'); ?><input type="hidden" name="action" value="wei_generate_ebay_de_category_suggestions" /><input type="hidden" name="restart" value="1" /><label>Batch <input type="number" min="1" max="500" name="limit" value="50" /></label><label>Mode <select name="mode"><option value="leaf_with_products">leaf categories with products</option><option value="with_products">all categories with products</option><option value="all_categories">all categories</option></select></label><label><input type="checkbox" name="force_refresh" value="1" /> force refresh cache</label><button class="button button-primary">Pobierz sugestie kategorii eBay.de</button></form><form method="post" action="<?php echo esc_url($adminPostUrl); ?>"><?php wp_nonce_field('wei_generate_ebay_de_category_suggestions'); ?><input type="hidden" name="action" value="wei_generate_ebay_de_category_suggestions" /><input type="number" min="1" max="500" name="limit" value="50" /><button class="button">Continue eBay.de suggestions</button></form></div>
