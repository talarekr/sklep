    ...
    public function translate_product_content(\WC_Product $product, array $context): array
    {
        ...
        $payload = [
            ...
            'messages' => [
                [
                    'role' => 'system',
                    'content' => 'You translate Polish WooCommerce auto-parts listings into German for eBay.de. Return only valid JSON with title_de and description_de. Do not invent facts. Preserve brand/manufacturer, MPN/OE numbers, condition, compatibility and technical notes. The title must be German, plain text, no HTML, concise, max 80 characters. Description must be German and may use simple safe HTML tags only.',
                ],
                [
                    'role' => 'user',
        ...
        if ($title === '' || $description === '') {
            throw new \RuntimeException('OpenAI translation response was missing German title or description.');
        }
