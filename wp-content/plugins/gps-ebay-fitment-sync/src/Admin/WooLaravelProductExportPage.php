...
final class WooLaravelProductExportPage
{
    ...
    public function download(): void
    {
        ...
        if ($file === 'summary' || substr($file, -5) === '_json' || substr($file, -8) === '_summary') header('Content-Type: application/json; charset=utf-8');
