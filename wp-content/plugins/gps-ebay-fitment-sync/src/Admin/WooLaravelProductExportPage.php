...
final class WooLaravelProductExportPage
{
    ...
    public function ajaxMarketplaceMappingFilesystemDiagnostic(): void { $this->guardAjax(); wp_send_json_success((new MarketplaceMappingExport())->filesystemDiagnostic()); }
