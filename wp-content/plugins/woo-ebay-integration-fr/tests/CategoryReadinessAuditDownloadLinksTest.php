...
$assert(str_contains($adminSource, "update_option('wei_fr_ebay_last_category_readiness_audit'"), 'Run category readiness audit must persist last audit metadata.');
...
$assert(str_contains($adminSource, "admin-post.php?action=download_wei_fr_report&file="), 'Audit CSV links must include the admin-post download fallback.');
