...
$GLOBALS['wei_fr_test_product_terms'][1] = [$term(5063)];
...
$GLOBALS['wei_fr_test_product_terms'][2] = [$term(6002)];
...
$GLOBALS['wei_fr_test_product_terms'][3] = [$term(7002)];
...
$GLOBALS['wei_fr_test_product_terms'][4] = [$term(5066), $term(7001)];
...
$GLOBALS['wei_fr_test_product_terms'][5] = [$term(9999)];
...
$GLOBALS['wei_fr_test_product_terms'][6] = [$term(9998)];
$r = EbayShippingPolicyResolver::resolve_for_product(6, $ebayCategoryOnlySettings);
$assert($r['blocked'] === true && $r['reason'] === 'missing_fr_shipping_policy_mapping', 'Old eBay/default category IDs must not be used for FR shipping category mapping.');
...
$assert(str_contains($adapterSource, 'missing_fr_shipping_policy_mapping') && str_contains($adapterSource, 'blocked_by_fr_shipping_policy'), 'FR publish readiness must block missing or invalid FR shipping policy mapping.');
