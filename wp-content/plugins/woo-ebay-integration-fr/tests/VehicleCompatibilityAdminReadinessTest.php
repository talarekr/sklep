...
$assert(str_contains($adminSource, "add_action('admin_post_wei_fr_vehicle_compatibility_diagnostics'"), 'Single-product vehicle diagnostics admin hook must be registered.');
$assert(str_contains($adminSource, "add_action('admin_post_wei_fr_run_vehicle_compatibility_audit'"), 'Batch vehicle compatibility audit admin hook must be registered.');
...
$assert(str_contains($viewSource, 'name="action" value="wei_fr_run_vehicle_compatibility_audit"'), 'Batch audit button must submit dedicated action.');
