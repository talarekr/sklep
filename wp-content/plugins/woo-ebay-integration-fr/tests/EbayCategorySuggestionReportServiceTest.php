...
$assert(str_contains($joinedQueries, 'Autoteile'), 'AC hose query should include French automotive context.');
...
foreach (['woo_subcategory_id', 'current_ebay_category_valid', 'suggested_ebay_category_id_3', 'raw_polish_query', 'translated_french_query', 'query_used', 'query_source', 'translation_source', 'taxonomy_error'] as $column) {
