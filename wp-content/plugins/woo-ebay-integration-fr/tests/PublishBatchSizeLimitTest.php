...
$publishSectionEnd = $publishSectionStart === false ? false : strpos($viewSource, 'data-wei-module="french-content"', $publishSectionStart);
...
foreach ([
    'name="action" value="wei_fr_auto_sync_export_now"' => 'Export ready products form missing action.',
    'name="action" value="wei_fr_ebay_initial_publish_batch"' => 'Publish ready offers form missing action.',
    'name="action" value="wei_fr_publish_ready_products"' => 'Publish ready products form missing action.',
...
$publishReadyProductsFormStart = strpos($publishSection, 'name="action" value="wei_fr_publish_ready_products"');
