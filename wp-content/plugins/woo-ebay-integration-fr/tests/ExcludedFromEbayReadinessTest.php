...
$assert(strpos($preflightBlock, 'excluded_from_ebay_preflight') < strpos($preflightBlock, 'resolve_french_content'), 'Excluded products must return from preflight before content/category/aspect readiness checks.');
