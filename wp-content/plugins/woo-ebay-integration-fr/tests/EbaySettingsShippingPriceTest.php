...
$assert(str_contains($adminSource, "add_action('admin_post_wei_fr_save_ebay_settings'") && str_contains($adminSource, 'public function save_ebay_settings'), 'Dedicated visible eBay settings save handler must exist.');
