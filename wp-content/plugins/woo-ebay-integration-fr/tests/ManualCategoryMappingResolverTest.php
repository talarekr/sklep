...
class ManualCategoryMappingResolverFakeWpdb
{
    ...
    {
        if (!str_contains($query, 'wp_wei_fr_ebay_category_mappings')) {
            return [];
        }
        preg_match("/marketplace_id='([^']+)'/", $query, $marketplaceMatch);
        preg_match('/woo_term_id=(\d+)/', $query, $termMatch);
        $marketplace = $marketplaceMatch[1] ?? 'EBAY_FR';
...
$wpdb->rows = [
    ['id' => 10, 'marketplace_id' => 'EBAY_FR', 'woo_term_id' => 7, 'ebay_category_id' => 'rule-older', 'source' => 'rule', 'status' => 'mapped_auto', 'updated_at' => '2026-01-01 00:00:00', 'created_at' => '2026-01-01 00:00:00'],
    ['id' => 11, 'marketplace_id' => 'EBAY_FR', 'woo_term_id' => 7, 'ebay_category_id' => 'import-newer', 'source' => 'import', 'status' => 'mapped_manual', 'updated_at' => '2026-02-01 00:00:00', 'created_at' => '2026-02-01 00:00:00'],
    ['id' => 12, 'marketplace_id' => 'EBAY_FR', 'woo_term_id' => 7, 'ebay_category_id' => 'manual-old', 'source' => 'manual', 'status' => 'mapped_manual', 'updated_at' => '2026-01-15 00:00:00', 'created_at' => '2026-01-15 00:00:00'],
    ['id' => 13, 'marketplace_id' => 'EBAY_FR', 'woo_term_id' => 7, 'ebay_category_id' => 'manual-new', 'source' => 'manual', 'status' => 'mapped_manual', 'updated_at' => '2026-03-01 00:00:00', 'created_at' => '2026-03-01 00:00:00'],
    ['id' => 20, 'marketplace_id' => 'EBAY_FR', 'woo_term_id' => 5197, 'ebay_category_id' => '262084', 'source' => 'legacy', 'status' => 'mapped_auto', 'updated_at' => '2026-01-01 00:00:00', 'created_at' => '2026-01-01 00:00:00'],
];

$repo = (new ReflectionClass(CategoryMappingRepository::class))->newInstanceWithoutConstructor();
$selected = $repo->resolveProductionCategoryMapping(7, 'EBAY_FR');
$failures = [];
...
$saved = $repo->save_manual_mapping(7, 'EBAY_FR', ['category_id' => '33573', 'category_name' => 'Leaf', 'category_path' => 'Auto & Motorrad Teile > Leaf']);
$selected = $repo->resolveProductionCategoryMapping(7, 'EBAY_FR');
...
$savedWorklist = $repo->save_manual_worklist_mapping(5197, 'EBAY_FR', ['category_id' => '33566', 'category_name' => 'Pompa ABS', 'category_path' => 'Auto > Brakes > ABS pumps']);
$selectedWorklist = $repo->resolveProductionCategoryMapping(5197, 'EBAY_FR');
