...
{
    private const TRANSIENT_KEY = 'wei_fr_nbp_eur_rate';
    private const LAST_OPTION_KEY = 'wei_fr_nbp_eur_rate_last';
    ...
    {
        $this->logger->info('Resolved EBAY_FR offer price from WooCommerce PLN price', [
