        ...
        foreach ($product_ids as $product_id) {
            ...
            if (!$product instanceof \WC_Product) {
                $rows[] = [
                    ...
                    'best_available_source_still_extreme' => false,
                    'needs_extreme_ratio_fallback' => false,
            ...
            $rows[] = [
                ...
                'best_available_source_still_extreme' => !empty($diagnostics['best_available_source_still_extreme']),
                'needs_extreme_ratio_fallback' => !empty($diagnostics['needs_extreme_ratio_fallback']),
