...
class OvokoDonorCarsCsvExportService
{
    ...
    private function count_unresolved(array &$summary, array $row): void
    {
        ...
        $this->count_resolution($summary, $row, 'steering_side', 'car_wheel_type_raw_id', 'vehicle_steering_position');
        ...
        $summary['unresolved_fields_counts'] = [
            ...
            'drive' => (int) $summary['unresolved_drive_count'], 'steering_side' => (int) $summary['unresolved_steering_side_count'], 'body_type' => (int) $summary['unresolved_body_type_count'], 'color' => (int) $summary['unresolved_color_count'],
        ];
        $this->update_laravel_safety($summary);
        ...
        $resolvedTotal = (int) $summary['resolved_model_count'] + (int) $summary['resolved_fuel_count'] + (int) $summary['resolved_gearbox_count'] + (int) $summary['resolved_drive_count'] + (int) $summary['resolved_steering_side_count'] + (int) $summary['resolved_body_type_count'] + (int) $summary['resolved_color_count'];
        $unresolvedTotal = (int) $summary['unresolved_model_count'] + (int) $summary['unresolved_fuel_count'] + (int) $summary['unresolved_gearbox_count'] + (int) $summary['unresolved_drive_count'] + (int) $summary['unresolved_steering_side_count'] + (int) $summary['unresolved_body_type_count'] + (int) $summary['unresolved_color_count'];
