...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (rebuildBox && rebuildStatusEl && rebuildLogsEl) {
    ...
    const rebuildRender = function (status, response) {
      status = status || {};
      response = response || {};
      ['status','current_after_product_id','next_after_product_id','last_safe_next_after_product_id','processed_total','fixed_total','skipped_total','errors_total','missing_ovoko_id_total','missing_category_id_total','missing_category_path_total','skipped_missing_ovoko_id_total','skipped_missing_category_id_total','skipped_missing_category_path_total','skipped_ovoko_fetch_failed_total','skipped_category_resolution_failed_total','api_errors_total','categories_created_total','categories_existing_total','category_assignments_changed_total','menu_cache_rebuild','menu_cache_category_count','menu_cache_build_duration','batches_done_since_cache_rebuild','started_at','updated_at','duration','last_error'].forEach(function (k) { rebuildSetK(k, status[k] || 0); });
