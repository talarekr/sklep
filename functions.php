...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_style('gp-clone-style', get_stylesheet_uri(), ['gp-poppins'], '1.3.10');
    ...
    if (class_exists('WooCommerce')) {
        wp_enqueue_style('gp-clone-woo', get_template_directory_uri() . '/assets/css/woocommerce.css', ['gp-clone-style'], '1.3.10');
